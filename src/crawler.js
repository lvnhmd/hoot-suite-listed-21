...
const scrapePage = (url, promises) => new Promise((resolve, reject) => {
  rp(url)
    .then((html) => {
      ...
      const last = parseInt($('li.last > a', html)['0'].attribs.href.match(/\d+/)[0].trim(), 10);
...
exports.crawlGoodHousekeeping = () => new Promise((resolve) => scrapePage('https://comps.goodhousekeeping.co.uk/', [])
